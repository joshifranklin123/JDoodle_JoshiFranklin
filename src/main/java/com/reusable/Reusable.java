...
public class Reusable extends Baseclass {
    ...
    public void Assert_upload(WebElement Element1,String st1,WebElement Element2,String st2) {
		String assne1 = Element1.getText();
		String assne2 = Element2.getText();
		try {
			Assert.assertEquals(st2, assne2);
			System.out.println("Captcha is appeard did not automated");

			
		} catch (Throwable thro) {
			
			Assert.assertEquals(st1, assne1);
