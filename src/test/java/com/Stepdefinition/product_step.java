...
public class product_step extends Reusable {
	...
	public void the_user_scrolls_down_the_documentation_to_explore_a_topic() throws InterruptedException {
		implicitywait();
		to_Click(prpg.getGot_it_product());
		Thread.sleep(3000);
	   scrolldwon(prpg.getScroll_find());
	}

	@When("The user clicks on the find out button")
	public void the_user_clicks_on_the_find_out_button() throws InterruptedException, AWTException {
		implicitywait();
		Thread.sleep(5000);
		press_downkey(3);
